...
extern "C" {
	...
	__declspec(dllexport) void trainLinearClassification(double* dataset, int datasetSize, int* expectedOutputs, double* model, int modelSize, double nbIter, double learning);
